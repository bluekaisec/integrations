/*
####################################################################################################
### ORACLE BLUEKAI : ADOBE TARGET : GLOBAL BOX : mboxDefine() mboxUpdate() : JSON Return handler ###
####################################################################################################
...
window.bk_adobet_integration.bluekai_jsonreturn_id = "43292"; // BT ID
window.bk_adobet_integration.wait_in_ms = 5000; // How long to wait before asking BlueKai for the latest categories and firing Adobe pixel (default 5000ms)
...
bk_adobet_integration.functions.generateMbox = function() {
    ...
    if (typeof mboxDefine === "function") {
        ...
        // Removing <div> creation - not needed
...
bk_adobet_integration.functions.callBlueKai = function(bluekai_jsonreturn_id) {
    ...
    if ((document.head && document.head.innerHTML.indexOf(bluekai_jsonreturn_id + '?ret=js') > -1) || (document.body && document.body.innerHTML.indexOf(bluekai_jsonreturn_id + '?ret=js') > -1)) {
        ...
        }, window.bk_adobet_integration.wait_in_ms);
